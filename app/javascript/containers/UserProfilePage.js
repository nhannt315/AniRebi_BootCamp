...
import { Breadcrumb, Layout, Row, Card, Col, Icon, Avatar, message, Spin } from 'antd';
          ...
          <Row gutter={16} style={{marginTop: '10px'}}>
            <Col span={6}>
              <Card
                ...
                actions={actionss}>
                <Meta
                  avatar={<StyledAvatar size="large" style={{
                    color: '#f56a00',
                    backgroundColor: '#fde3cf'
                  }}>{userInfo.name.charAt(0).toUpperCase()}</StyledAvatar>}
                  title={userInfo.name}
            ...
            <Col span={18}>
              {
                this.props.isAuthenticated && this.state.isEdit ? <EditProfile handleUpdate={this.updateProfileInfo}/> :
                  <ProfileInfo dataSource={userInfo.reviews}/>
              }
            </Col>
          </Row>
        </Content>
