...
export const GET_TOP_ANIMES = '/api/v1/animes/top_animes';
export const GET_ANIMES_BY_ID = '/api/v1/animes';
export const GET_GENRES_LIST = '/api/v1/genres/all_genres';
export const GET_GENRE_TOP = '/api/v1/genres';
export const REVIEW_API = '/api/v1/reviews';
export const GET_REVIEWS_BY_ANIME = '/api/v1/reviews/get_by_anime';
export const GET_GENRE_DETAIL = '/api/v1/genres';
